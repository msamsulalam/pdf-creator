...
<div id="main-wrapper">
    ...
    ***********************************-->
    <div class="nav-header">
        <div class="brand-logo"><b><img src="{{asset('logo.png')}}" alt="">
            </b><span class="brand-title" style="padding-left: 12px;">ECOMERCE</span>
        </div>
                ...
                @if($user->is_admin())
                    ...
                    <li class="{{Route::is('dashboard')?'active':''}} mega-menu mega-menu-sm">
                        <a class="has-arrow" href="{{route('dashboard')}}" aria-expanded="false">
                            <i class="mdi mdi-page-layout-body"></i><span class="nav-text">Reservation</span></a>
                    </li>
                    ...
                    <li class="{{Route::is('places')?'active':''}} mega-menu mega-menu-lg">
                        <a class="has-arrow" href="{{route('places')}}" aria-expanded="false">
                            <i class="mdi mdi-chart-bar"></i> <span class="nav-text">Addresses</span>
                        </a>
                    </li>
                    ...
                    <li class="{{Route::is('time-ranges')?'active':''}} mega-menu mega-menu-lg">
                        <a class="has-arrow" href="{{route('time-ranges')}}" aria-expanded="false">
                            <i class="mdi mdi-clock"></i> <span class="nav-text">Time Ranges</span>
                        </a>
                    </li>
                @endif
                @if($user->is_client())
                    <li class="{{Route::is('client-dashboard')?'active':''}} mega-menu mega-menu-lg">
                        <a class="has-arrow" href="{{route('client-dashboard')}}" aria-expanded="false">
                            <i class="mdi mdi-chart-bar"></i> <span class="nav-text">Reservation</span>
                        </a>
                    </li>
                    <li class="{{Route::is('catalog')?'active':''}} mega-menu mega-menu-lg">
                        <a class="has-arrow" href="{{route('catalog')}}" aria-expanded="false">
                            <i class="mdi mdi-chart-bar"></i> <span class="nav-text">Products</span>
                        </a>
                    </li>
