                            ...
                            <div class="basic-form">
                                <form action="{{route('update-product', $product[0]->id)}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-check mb-5 mr-5">
                                        <input id="checkbox11" class="form-check-input styled-checkbox" name="show_hide"
                                               @if($product[0]->show_hide == 1)
                                                       checked=""
                                               @endif
                                               type="checkbox">
                                        <label for="checkbox11" class="form-check-label check-green">Don't show on the user side</label>
                                    </div>
                                    <div class="form-group">
