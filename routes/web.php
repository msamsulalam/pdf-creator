...
//    });
    ...
    Route::post('orders-export', 'HomeController@pdfDownload')->name('pdf-export');
    ...
    //Route::get('exp-pdf', 'HomeController@pdfDownload')->name('pdf-exp');
//    product crud
...
//areas
    ...
    //Time Ranges
    Route::get('time-ranges', 'TimeRangeController@index')->name('time-ranges');
    Route::post('time-ranges/add', 'TimeRangeController@store')->name('add-time');
    Route::post('time-ranges/get', 'TimeRangeController@show')->name('get-time');
    Route::post('time-ranges/update/{id}', 'TimeRangeController@update')->name('update-time');
    Route::get('time-ranges/delete/{id}', 'TimeRangeController@destroy')->name('delete-time');
...
Route::group(['prefix'=>'client'], function (){
    ...
    Route::post('auto-order', 'OrdersController@autoOrder')->name('auto-order');
    Route::post('setup-auto-order/{id}', 'OrdersController@SetupAutoOrder')->name('setup-auto-order');
...
//    order history start
    ...
    Route::get('order-detail/{id}', 'OrderDetailController@index')->name('client-order-detail');
